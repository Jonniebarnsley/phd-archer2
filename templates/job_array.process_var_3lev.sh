...
#SBATCH --job-name=process_@VAR_3lev
#SBATCH --output=output/process_@VAR_3lev_%A_%a.o
#SBATCH --error=error/process_@VAR_3lev_%A_%a.e
...
RUN_DIR=@ENSEMBLEDIR/run${RUN_ID}

# process netcdf
python -u $WORK/lib/process_netcdf.py --lev 3 @VAR $RUN_DIR/plot @NCDIR
