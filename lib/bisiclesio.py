...
class BisiclesFile:
    ...
    def attrs(self):
        ...
        return {
            ...
            "muCoef"        : {"units": "unitless",    "long_name": "Damage coefficient"}
            }
    ...
    def read_dataset(self, variable: str, lev: int=0, order: int=0) -> Dataset:
        """Extract 2D dataset from AMR file and return as xarray Dataset"""
